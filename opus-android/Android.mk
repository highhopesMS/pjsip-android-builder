# Android.mk for Opus codec
# Included in pjsip-android-builder repository to avoid external downloads
...
LOCAL_SRC_FILES := $(OPUS_SOURCES) $(OPUS_SOURCES_CELT) $(OPUS_SOURCES_SILK) $(OPUS_SOURCES_SILK_FIXED)
